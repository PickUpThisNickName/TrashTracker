...
Запустите powershell, cmd или другой shell и **обязательно** переместитесь в папку со скриптом с помощью команды "cd". Запустите скрипт VR_IT_tracker.py с помощью команды python VR_IT_tracker.py. Далее введите имя папки с входными данными, которая должна находится в той же папке что и скрипт.
